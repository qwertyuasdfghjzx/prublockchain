...
Bu vizyon, Yağ Analizi Kayıt Defteri modelini sadece teknik bir güncelleme olmaktan çıkarıp, tüm sektörü dönüştüren stratejik bir Web3 hamlesine dönüştürür.
...
/**
 * @title Yağ Analizi Kayıt Defteri Mülkiyet ve Kayıt Akıllı Sözleşmesi
 * @notice Piri Reis Üniversitesi Blockchain Akademisi Eğitim Kaynağı.
 */
contract YaAnaliziKaytDefteriContract is ERC721, Ownable {
    ...
    constructor() ERC721("Yağ Analizi Kayıt DeNFT", "PRUME-4") Ownable(msg.sender) {}
...
Yağ Analizi Kayıt Defteri çözümü, üç temel aşamadan oluşan şeffaf ve otomatik bir iş akışı döngüsünü takip eder:

1. **Aşama 1 - Numune Alımı:** 
   Gemi makine ekibi yağ numunesi alır, barkodunu zincirde gemiye kaydeder.
2. **Aşama 2 - Laboratuvar Girişi:** 
   Analiz laboratuvarı testi yapar, verileri doğrudan blockchain API'sine imzalı gönderir.
3. **Aşama 3 - Kritik Uyarı:** 
   Eğer metal aşınma oranı yüksekse akıllı sözleşme gemi ekibine acil alarm iletir.
